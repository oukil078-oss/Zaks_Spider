...
import { 
  ...
  ExternalLink, Search, Crosshair, ChevronRight, Zap, RefreshCw, X
} from 'lucide-react';
...
export const SocView: React.FC<SocViewProps> = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setAttacks((prev) => [newAttack, ...prev.slice(0, 39)]); // Keep latest 40 attacks
    }, 4500);
  ...
  return (
    <div className="flex-1 w-full h-full flex flex-col gap-3 overflow-hidden font-mono">
      {/* Main Grid: Left Stage (Globe) + Right Deck (Attack Stream) */}
      <div className="flex-1 w-full grid grid-cols-1 lg:grid-cols-12 gap-3.5 overflow-hidden">
        ...
        <div className="lg:col-span-8 flex flex-col h-full rounded-2xl bg-[#060b14]/90 border border-cyan-500/20 overflow-hidden relative shadow-2xl">
          ...
          <div className="flex-1 w-full h-full relative">
            ...
            {/* Selected Attack Floating Target Card */}
            {selectedAttack && (
              <div className="absolute top-3 right-3 max-w-sm p-3 rounded-xl bg-[#0a101d]/90 border border-cyan-400/40 shadow-[0_0_20px_rgba(0,240,255,0.2)] backdrop-blur-xl animate-in fade-in slide-in-from-top-2">
        ...
        {/* Right Stacked Deck: Live Worldwide Attacks Stream (~35% width) */}
        <div className="lg:col-span-4 flex flex-col h-full rounded-2xl bg-[#080e1a]/95 border border-cyan-500/20 shadow-2xl backdrop-blur-xl overflow-hidden">
          {/* Deck Header matching wireframe */}
          <div className="p-3 border-b border-cyan-500/20 flex items-center justify-between bg-[#0a1222]">
            <div className="flex items-center gap-2">
              <ShieldAlert className="w-4 h-4 text-cyan-400 animate-pulse" />
              <span className="text-xs font-bold text-white uppercase tracking-wider">
                Worldwide Attacks Deck
              </span>
              <span className="px-1.5 py-0.2 text-[9px] rounded bg-cyan-500/20 text-cyan-300 border border-cyan-500/30">
                LIVE
              </span>
            </div>
            ...
            <div className="flex items-center gap-1">
              ...
              >
                {filterSeverity === 'CRITICAL' ? 'CRITICAL ONLY' : 'ALL SEV'}
              </button>
            </div>
          </div>
          ...
          <div className="p-2 border-b border-cyan-500/10 bg-[#060a14]">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search actor, vector, city, CVE..."
          ...
          {/* Stacked Cards Stream (Scrollable) */}
      ...
      {/* Bottom Bar: Quick Filter and Telemetry matching wireframe */}
      <div className="w-full p-2.5 rounded-2xl bg-[#080d18]/90 border border-cyan-500/20 flex flex-wrap items-center justify-between gap-3 text-xs">
        <div className="flex items-center gap-3">
          ...
          <span className="text-slate-300">
            Filtering 40 Live Ballistic Trajectories // Auto-Rotate Active // High-Resolution Borders Active
          </span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span>Refresh Seed Trajectories</span>
          </button>
        </div>
      </div>
