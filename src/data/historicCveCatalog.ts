// ==========================================
// ZAK'S SPIDER — HISTORIC VULNERABILITY HALL OF FAME & EXPLOIT ARCHIVE
// Comprehensive catalog spanning 1999–2026 with CVSS, EPSS, Metasploit modules,
// Exploit-DB references, weaponization indicators, and PenTest Lab pivot links.
// ==========================================

import { VulnNewsItem } from '../types';

export const HISTORIC_CVE_CATALOG: VulnNewsItem[] = [
